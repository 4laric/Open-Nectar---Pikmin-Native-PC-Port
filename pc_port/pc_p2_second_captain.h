...
// Whether this build may actually birth a live second Navi. Open now that the
// second captain renders and its input is skipped when inactive; default
// single-captain play still never spawns one (request-gated by
