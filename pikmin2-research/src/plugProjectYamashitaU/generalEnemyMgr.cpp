// P2 Bomb birth-hook engine surface (#684, #616 provider, #577 payload).
// (dual-mode header comment omitted here for brevity; full text in commit)
#ifdef P2_BOMB_BIRTH_ARM_STANDALONE
#include <cstddef>
typedef unsigned char u8;
struct EnemyMgrBase { virtual ~EnemyMgrBase() {} void alloc() {} };
struct GameSystemStub { int mIsInCave = 0; };
static GameSystemStub g_gameSystem; static GameSystemStub* gameSystem = &g_gameSystem;
static const int TAMAGOMUSHI_GROUP_COUNT = 10;
static const int SHIJIMICHOU_GROUP_COUNT = 25;
struct EnemyMgrNode { EnemyMgrNode(int, char*, EnemyMgrBase*) {} };
struct EnemyMgrNodeList { void add(EnemyMgrNode*) {} };
struct SysStub { void heapStatusStart(char*, void*) {} void heapStatusEnd(char*) {} };
static SysStub g_sys; static SysStub* sys = &g_sys;
struct EnemyInfoFunc { static int getEnemyInfo(int, int) { return 0; } };
static char g_name[] = "test";
static char* getEnemyName(int, int) { return g_name; }
struct EnemyTypeID {
    static const int EnemyID_Armor = 15;
    static const int EnemyID_Baby = 31;
    static const int EnemyID_BigFoot = 69;
    static const int EnemyID_BigTreasure = 73;
    static const int EnemyID_BlackMan = 99;
    static const int EnemyID_BlueChappy = 42;
    static const int EnemyID_BlueKochappy = 44;
    static const int EnemyID_Bomb = 36;
    static const int EnemyID_BombOtakara = 93;
    static const int EnemyID_BombSarai = 58;
    static const int EnemyID_Catfish = 26;
    static const int EnemyID_Chappy = 2;
    static const int EnemyID_Chiyogami = 89;
    static const int EnemyID_Clover = 47;
    static const int EnemyID_DaiodoGreen = 86;
    static const int EnemyID_DaiodoRed = 85;
    static const int EnemyID_Damagumo = 56;
    static const int EnemyID_DangoMushi = 94;
    static const int EnemyID_Demon = 32;
    static const int EnemyID_Egg = 37;
    static const int EnemyID_ElecBug = 28;
    static const int EnemyID_ElecHiba = 22;
    static const int EnemyID_ElecOtakara = 62;
    static const int EnemyID_Fart = 11;
    static const int EnemyID_FireChappy = 33;
    static const int EnemyID_FireOtakara = 59;
    static const int EnemyID_Fkabuto = 96;
    static const int EnemyID_FminiHoudai = 97;
    static const int EnemyID_Frog = 17;
    static const int EnemyID_Fuefuki = 41;
    static const int EnemyID_GasHiba = 21;
    static const int EnemyID_GasOtakara = 61;
    static const int EnemyID_Hana = 84;
    static const int EnemyID_Hanachirashi = 55;
    static const int EnemyID_Hiba = 20;
    static const int EnemyID_HikariKinoko = 48;
    static const int EnemyID_Houdai = 66;
    static const int EnemyID_Imomushi = 65;
    static const int EnemyID_Jigumo = 63;
    static const int EnemyID_Kabuto = 75;
    static const int EnemyID_KareOoinu_l = 92;
    static const int EnemyID_KareOoinu_s = 91;
    static const int EnemyID_KingChappy = 53;
    static const int EnemyID_Kochappy = 1;
    static const int EnemyID_Kogane = 9;
    static const int EnemyID_KumaChappy = 35;
    static const int EnemyID_KumaKochappy = 76;
    static const int EnemyID_Kurage = 57;
    static const int EnemyID_LeafChappy = 67;
    static const int EnemyID_Magaret = 87;
    static const int EnemyID_Mar = 29;
    static const int EnemyID_MaroFrog = 18;
    static const int EnemyID_MiniHoudai = 78;
    static const int EnemyID_Miulin = 54;
    static const int EnemyID_Nekojarashi = 88;
    static const int EnemyID_OniKurage = 72;
    static const int EnemyID_OoPanModoki = 40;
    static const int EnemyID_Ooinu_l = 50;
    static const int EnemyID_Ooinu_s = 49;
    static const int EnemyID_PanHouse = 83;
    static const int EnemyID_PanModoki = 38;
    static const int EnemyID_Pelplant = 0;
    static const int EnemyID_Pom = 82;
    static const int EnemyID_Queen = 30;
    static const int EnemyID_Qurione = 16;
    static const int EnemyID_Rkabuto = 95;
    static const int EnemyID_Rock = 19;
    static const int EnemyID_Sarai = 23;
    static const int EnemyID_ShijimiChou = 77;
    static const int EnemyID_SnakeCrow = 34;
    static const int EnemyID_SnakeWhole = 70;
    static const int EnemyID_Sokkuri = 79;
    static const int EnemyID_Tadpole = 27;
    static const int EnemyID_TamagoMushi = 68;
    static const int EnemyID_Tank = 24;
    static const int EnemyID_Tanpopo = 46;
    static const int EnemyID_Tobi = 14;
    static const int EnemyID_Tukushi = 80;
    static const int EnemyID_Tyre = 98;
    static const int EnemyID_UjiA = 12;
    static const int EnemyID_UjiB = 13;
    static const int EnemyID_UmiMushiBase = 100;
    static const int EnemyID_Wakame_l = 52;
    static const int EnemyID_Wakame_s = 51;
    static const int EnemyID_Watage = 81;
    static const int EnemyID_WaterOtakara = 60;
    static const int EnemyID_Wealthy = 10;
    static const int EnemyID_Wtank = 25;
    static const int EnemyID_YellowChappy = 43;
    static const int EnemyID_YellowKochappy = 45;
    static const int EnemyID_Zenmai = 90;
};
struct Armor { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Baby { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BigFoot { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BigTreasure { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BlackMan { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BlueChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BlueKochappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Bomb { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BombOtakara { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct BombSarai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Catfish { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Chappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Chiyogami { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Clover { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Damagumo { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct DangoMushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Demon { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct DiodeGreen { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct DiodeRed { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Egg { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct ElecBug { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct ElecHiba { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct ElecOtakara { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Fart { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct FireChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct FireOtakara { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct FixKabuto { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct FixMiniHoudai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Frog { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Ftank { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Fuefuki { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct GasHiba { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct GasOtakara { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct GreenKabuto { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Hana { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Hanachirashi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Hiba { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct HikariKinoko { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Houdai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Imomushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Jigumo { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct KareOoinu_l { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct KareOoinu_s { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct KingChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Kochappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Koganemushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct KumaChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct KumaKochappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Kurage { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct LeafChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Mar { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Margaret { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct MaroFrog { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Miulin { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Nekojarashi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Nest { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct NormMiniHoudai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct OniKurage { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct OoPanModoki { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Ooinu_l { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Ooinu_s { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct PanModoki { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Pelplant { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Pom { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Queen { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Qurione { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct RedKabuto { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Rock { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Sarai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct ShijimiChou { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct SnakeCrow { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct SnakeWhole { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Sokkuri { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Tadpole { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct TamagoMushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Tanpopo { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Tobi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Tukushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Tyre { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Ujia { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Ujib { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct UmiMushi { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Wakame_l { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Wakame_s { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Watage { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct WaterOtakara { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Wealthy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Wtank { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct YellowChappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct YellowKochappy { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct Zenmai { struct Mgr : EnemyMgrBase { Mgr(int, int) {} }; };
struct GeneralEnemyMgr {
    static EnemyMgrNodeList mEnemyMgrNode;
    static void add(EnemyMgrBase*) {}
    static void createEnemyMgr(u8 viewNum, int enemyID, int limit);
};
EnemyMgrNodeList GeneralEnemyMgr::mEnemyMgrNode;
extern void pc_p2_bomb_birth_hook_notify(int enemyID);
#else
...
#endif
#ifndef P2_BOMB_BIRTH_ARM_STANDALONE
...
#else
#endif
// === VERBATIM dispatch with DIRECT notifier calls (both modes) ===
